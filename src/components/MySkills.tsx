...
const MySkills = () => {
  ...
  return (
    <section id="skills" className="pt-10 pb-20 mt-32 h-full md:h-screen">
      <div className="grid grid-cols-12 grid-row-4 gap-4 ">
        <div className="col-start-2 col-end-6 row-start-1 row-end-2">
          <h2 className="font-dmmono text-4xl bg-gradient-greenblue bg-clip-text font-bold text-transparent">
            My Skills
          </h2>
        </div>
